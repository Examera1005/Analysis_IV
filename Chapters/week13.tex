...
$$ \hat{u}(a,t) = \mathcal{F}\left[ \frac{1}{\sqrt{2t}} e^{-\frac{x^2}{4t}} \right](a) \cdot \mathcal{F}[u_0](a) + \int_0^t \mathcal{F}\left[ \frac{1}{\sqrt{2(t-s)}} e^{-\frac{x^2}{4(t-s)}} \right](a) \cdot \mathcal{F}[f(x,s)](a) \dd s $$
...
\[
u(x,t) = P[u_0](x,t) + \int_0^t P[f|_{t=s}](x, t-s) \mathrm{d}s
\]
\end{theorem}
